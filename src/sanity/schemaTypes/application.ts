  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'pekerjaan_ayah', title: 'Pekerjaan Ayah', type: 'string' }),
        defineField({ name: 'kondisi_ibu', title: 'Kondisi Ibu', type: 'string' }),
        defineField({ name: 'pekerjaan_ibu', title: 'Pekerjaan Ibu', type: 'string' }),
        ...
        defineField({ name: 'has_sktm', title: 'Punya SKTM?', type: 'string' }),
        defineField({ name: 'file_sktm', title: 'SKTM (Foto)', type: 'image', options: { hotspot: true } }),
        defineField({ name: 'has_skb', title: 'Punya SKB?', type: 'string' }),
